...
INSERT INTO rental_instrument_inventory (type_of_instrument, instrument_brand, instrument_model_number, instrument_name, rented)
  VALUES
    ...
    ('Guitar', 'Les Paul', 'LF3919450', 'Fender', TRUE),
  	('Bagpipe', 'Mctavish', 'MH1355211', 'Haggis', TRUE),
    ('Bagpipe', 'Mctavish', 'MH5245151', 'Haggis', TRUE),
    ...
    ('Bagpipe', 'Mctavish', 'MN4567234', 'Nessie', TRUE),
  	('Saxophone', 'Jupiter', 'JW4910501', 'Whisper', TRUE),
    ('Saxophone', 'Jupiter', 'JW4489291', 'Whisper', TRUE),
    ('Saxophone', 'Jupiter', 'JW3950195', 'Whisper', TRUE),
    ('Saxophone', 'Jupiter', 'JW5910414', 'Whisper', TRUE),
